...
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '行为日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dp_admin_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 336 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台菜单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `dp_admin_menu` VALUES (330, 329, 'customer', '客户列表', 'fa fa-fw fa-list', 'module_admin', 'customer/customerlist/index', '_self', 0, 1546692676, 1546692676, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (331, 329, 'customer', '经期设置', 'fa fa-fw fa-th', 'module_admin', 'customer/periodlist/index', '_self', 0, 1546694614, 1546694614, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (332, 329, 'customer', '经期记录', 'fa fa-fw fa-align-left', 'module_admin', 'customer/menstrualist/index', '_self', 0, 1546694685, 1546694685, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (333, 329, 'customer', '留言列表', 'fa fa-fw fa-wechat', 'module_admin', 'customer/leavelist/index', '_self', 0, 1546695190, 1546695190, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (334, 333, 'customer', '留言回复', 'fa fa-fw fa-commenting', 'module_admin', 'customer/leavelist/reply', '_self', 0, 1546695269, 1546695269, 100, 0, 1, '');
INSERT INTO `dp_admin_menu` VALUES (335, 329, 'customer', '测试接口', 'fa fa-fw fa-windows', 'module_admin', 'api/index/index', '_self', 0, 1546695338, 1546695338, 100, 0, 1, '');
...
CREATE TABLE `dp_admin_module`  (
  ...
  `status` tinyint(2) NOT NULL DEFAULT 1 COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '模块表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `dp_admin_user` VALUES (1, 'admin', '超级管理员', '$2y$10$Brw6wmuSLIIx3Yabid8/Wu5l8VQ9M/H/CG3C9RqN9dUCwZW3ljGOK', '', 0, '', 0, 0, 0.00, 0, 1, 0, 0, 1476065410, 1547007253, 1547007253, 1851196401, 100, 1);
...
-- ----------------------------
INSERT INTO `dp_customer_periodsetting` VALUES (2, 'openid20181115', '小马', 18, 0, 0, 1543491359, 5, 28, 1, 0, 1542211200, 1539532800);
INSERT INTO `dp_customer_periodsetting` VALUES (4, 'openid20181115', '王妈妈', 38, 0, 1, 1539532800, 3, 28, 1, 0, NULL, 1539532800);
INSERT INTO `dp_customer_periodsetting` VALUES (5, 'o37294ps5fky9t3frBDIAt8H20qM', 'I Wf', 18, 0, 0, 1545062400, 5, 28, 1, 0, NULL, 1547126880);
...
-- ----------------------------
INSERT INTO `dp_customer_receive_address` VALUES (1, 'openid20181115', '大王', '18906050278', '福建省', '厦门市', '海沧区', '霞阳村西路102号');
INSERT INTO `dp_customer_receive_address` VALUES (2, 'openid20181115', '大王', '18906050278', '福建省', '厦门市', '海沧区', '海景东路12号');
